...
class Like {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".like-box").on("click", this.on_click_dispatcher.bind(this));
  }
...
class Search {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keydown", this.key_press_dispatcher.bind(this)); // event, function
