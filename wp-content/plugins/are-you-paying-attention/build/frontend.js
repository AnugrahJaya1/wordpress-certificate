...
div_to_update.forEach(function (div) {
  ...
  react_dom__WEBPACK_IMPORTED_MODULE_2___default().render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Quiz, data), div); // add data to props
  div.classList.remove("paying-attention-update-me");
});
function Quiz(props) {
  const [is_correct, set_is_correct] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined);
  const [is_correct_delayed, set_is_correct_delayed] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      className: (is_correct_delayed == true && index == props.correct_answer ? "no-click " : "") + (is_correct_delayed == true && index != props.correct_answer ? "fade-incorrect" : ""),
      onClick: is_correct == true ? undefined : () => handle_answer(index)
    }, is_correct_delayed == true && index == props.correct_answer && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    ...
    className: "incorrect-message " + (is_correct == false ? "correct-message--visible" : "")
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
